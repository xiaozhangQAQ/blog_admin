...
export default {
  ...
  methods:{
    upto(){
      this.loading = true;
      let basedata = this.$refs.rightUpData.form;
      let htmlcontent = this.$refs.editContent;
      let datas = {};
